...
class Metaclass_Gesture(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('hsi_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'hsi_interfaces.msg.Gesture')
            logger.debug(
...
class Gesture(metaclass=Metaclass_Gesture):
    ...
    def __init__(self, **kwargs):
        ...
        self.distance_hands = kwargs.get('distance_hands', float())
    ...
    def __eq__(self, other):
        ...
        if self.probability != other.probability:
            return False
        if self.distance_hands != other.distance_hands:
            return False
        return True
    ...
    def gesture(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'gesture' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._gesture = value
    ...
    def distance_hands(self):
        """Message field 'distance_hands'."""
        return self._distance_hands

    @distance_hands.setter
    def distance_hands(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'distance_hands' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'distance_hands' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._distance_hands = value
