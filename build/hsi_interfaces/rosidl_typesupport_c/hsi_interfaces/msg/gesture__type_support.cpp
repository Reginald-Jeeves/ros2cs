...
static const _Gesture_type_support_symbol_names_t _Gesture_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hsi_interfaces, msg, Gesture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hsi_interfaces, msg, Gesture)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hsi_interfaces, msg, Gesture)() {
  return &::hsi_interfaces::msg::rosidl_typesupport_c::Gesture_message_type_support_handle;
}
